...
<div class="page-wrapper">
							...
							<div class="col-lg-9 col-xl-10">
								<form class="">
									<div class="row row-cols-lg-2 row-cols-xl-auto g-2">
										...
										<div class="col">
											<div class="position-relative">
												<a href="/marketer/add-garage" type="button" class="btn btn-primary radius-30 "><i class="bx bx-plus me-0"></i> Add User
										</a>
											</div>
										</div>
										{{-- <div class="col">
    ...
    $isExpiringSoon = !$isExpired && $licenseExpireDate->lessThanOrEqualTo($currentDate->copy()->addMonth());  // Less than 1 month away, but not expired
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#garageDetailModal{{$garage->id}}" >
										<div>
    ...
    @endif
								...
								<td>
										...
										<a href="{{ route('edit-garage.marketer', $garage->id) }}" class="btn radius-10 ">
