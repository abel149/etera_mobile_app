									...
									<div class="row row-cols-auto g-2">
										<div class="col">
											<div class="position-relative">
												<input type="text" class="form-control ps-5 radius-30 " placeholder="Search Spare Part Shop..."> <span class="position-absolute top-50 product-show translate-middle-y"><i class="bx bx-search"></i></span>
											</div>
										</div>
										<div class="col">
					...
					<table class="table mb-0 align-middle">
						...
						<tbody>
							<tr>
								...
								<td>Phone</td>
								<td>
									<button type="button" class="btn radius-10 p-1"  data-bs-toggle="modal" data-bs-target="#details"><i class="bx bx-show me-0">Show</i>
									</button>
								</td>
...
$availablePartners = \App\Models\User::whereIn('role', ['shop','garage'])->whereNotIn('id', $partners->pluck('partner_id'))->get();
@endphp
<!-- Add Modal -->
		...
		<div class="modal-content">
			...
			<div class="modal-body">
                ...
                <div class="col-lg-6">
                    ...
                    <select required name="brands[]" class="form-select" id="multiple-select-clear-field" data-placeholder="Toyota, Suzuki,..." multiple>
                        <option value="">...</option>
                    </select>
                </div>
                <div class="col-lg-6">
                ...
                <div class="col-lg-6">
                    ...
                    <input name="license_expire_date" type="text" class="form-control" id="input6" placeholder="Date">
                </div>
                <div class="col-lg-8">
