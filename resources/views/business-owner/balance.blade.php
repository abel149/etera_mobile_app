		...
		<div class="card radius-10 shadow">
			<div class="card-body">
								<div class="text-center">
									...
									<button @if(auth()->user()->balance == 0) disabled @endif type="button" class="btn btn-primary radius-30" data-bs-toggle="modal" data-bs-target="#withdraw-some">Send Withdrawal Request</button> &nbsp;
								</div>
			</div>
		</div>
	</div>
