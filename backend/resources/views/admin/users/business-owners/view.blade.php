...
<div class="page-wrapper">
	<div class="page-content">
		<h3 class="">Business Owners List</h3>
		<div class="row">
			<div class="col-12">
				<div class="card">
					<div class="card-body">
									...
									<div class="row row-cols-auto g-2">
										<div class="col">
											<div class="position-relative">
												<input type="text" class="form-control ps-5 radius-30 " placeholder="Search Business Owner..."> <span class="position-absolute top-50 product-show translate-middle-y"><i class="bx bx-search"></i></span>
											</div>
										</div>
										<div class="col">
										...
										<div class="col">
											<div class="position-relative">
												<a href="/admin/add-business-owner" type="button" class="btn btn-primary radius-30 "><i class="bx bx-plus me-0"></i> Business Owner
										</a>
											</div>
										</div>
										<div class="col">
				...
				<div class="table-responsive lead-table">
					<table class="table mb-0 align-middle">
						...
						<tbody>
							@foreach($businessOwners as $garage)
							@php
							...
							@endphp
								...
								<td>
									<div class="d-flex align-items-center">
										<div data-bs-toggle="modal" data-bs-target="#businessDetailModal{{$garage->id}}">
								...
								<td>{{$garage->registeredBy?->name ?? 'No one'}}</td>
    ...
    @endif
								...
								{{-- <td>
									<a href="{{ route('admin.users.business-owners.edit', $garage->id) }}" class="btn btn-primary btn-sm radius-10">
										<i class="bx bx-edit"></i> Edit
									</a>
								
									<button type="button" class="btn btn-outline-danger btn-sm radius-10" data-bs-toggle="modal" data-bs-target="#singleDelete-{{ $garage->id }}">
								...
								<!-- Resources/views/admin/business-owner/index.blade.php -->
<td>
    <a href="{{ route('admin.business-owners.edit', $garage->id) }}" class="btn btn-sm radius-10">
...
<div class="modal fade" id="singleDelete{{$garage->id}}" tabindex="-1" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			...
			<div class="modal-body">Are you sure you want to delete this business owner user?</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-outline-secondary radius-30" data-bs-dismiss="modal">Cancel</button>
				<form action="{{ route('admin.business-owners.destroy', $garage->id) }}" method="POST" style="display:inline;">
					@csrf
					<button type="submit" class="btn btn-danger radius-30">Delete</button>
								...
								<div class="modal fade" id="businessDetailModal{{$garage->id}}" tabindex="-1" aria-hidden="true">
									<div class="modal-dialog modal-dialog-centered modal-lg">
										<div class="modal-content shadow-lg border-0 rounded-4" style="background: #f8f9fa;">
											<div class="modal-header" style="background: #7A2CB4; color: white; border-top-left-radius: 10px; border-top-right-radius: 10px;">
												<h5 class="modal-title fw-bold"  style="color: white;">Business Owners Details</h5>
											...
											<div class="modal-body p-5">
												...
												<div class="mb-4">
													...
													<img src="{{ asset('storage/' . $garage->license_image) }}" 
												...
												<div class="mb-4">
													<p class="font-weight-semibold"><strong>Business Stamp:</strong></p>
													<img src="{{ asset('storage/' . $garage->stamp_image) }}" 
														 alt="Business Stamp" 
														 class="img-fluid rounded" 
														 style="max-width: 300px; max-height: 200px; object-fit: contain;">
												</div>
...
<div class="modal fade" id="selectedDelete" tabindex="-1" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">Delete Business Owner Users</h5>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
			<div class="modal-body">Are you sure you want to delete the selected business owner users?</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-outline-secondary radius-30" data-bs-dismiss="modal">Cancel</button>
...
{{-- <div class="modal fade" id="singleDelete{{$garage->id}}" tabindex="-1" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-outline-secondary radius-30" data-bs-dismiss="modal">Cancel</button>
				<form action="{{ route('admin.business-owners.destroy', $garage->id) }}" method="POST">
					@csrf
					<button type="submit" class="btn btn-danger radius-30">Delete</button>
				</form>
			</div>
