							...
							<div class="col-lg-9 col-xl-10">
								<form class="">
									<div class="row row-cols-lg-2 row-cols-xl-auto g-2">
										...
										<div class="col">
											<div class="position-relative">
												<a href="/marketer/add-business-owner" type="button" class="btn btn-primary radius-30 "><i class="bx bx-plus me-0"></i> Add User
										</a>
											</div>
										</div>
										{{-- <div class="col">
    ...
    @endif
								...
								<td>
									...
									{{-- <a href="{{ route('admin.business-owners.edit', $garage->id) }}" class="btn btn-sm radius-10">
										...
										<!-- Edit Button -->
<a href="{{ route('marketer.business-owners.edit', $garage->id) }}" class="btn radius-10 p-1">
