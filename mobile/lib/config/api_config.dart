class ApiConfig {
  ...
  static const String registerBusinessOwner =
      '$baseUrl/register/business-owner';
  ...
  static String adminFloatProforma(int id) =>
      '$baseUrl/admin-mobile/proformas/$id/float';
  static String adminCloseProforma(int id) =>
      '$baseUrl/admin-mobile/proformas/$id/close';
  static String adminProformaDetail(int id) =>
      '$baseUrl/admin-mobile/proformas/$id';
  static String adminInboxShops(int id) =>
      '$baseUrl/admin-mobile/proformas/$id/inbox-shops';
  static String adminInboxGarages(int id) =>
      '$baseUrl/admin-mobile/proformas/$id/inbox-garages';
  static String adminSendToOwner(int id) =>
      '$baseUrl/admin-mobile/proformas/$id/send-to-owner';
  static String adminRejectProforma(int id) =>
      '$baseUrl/admin-mobile/proformas/$id/reject';
  static const String adminApprovals = '$baseUrl/admin-mobile/approvals';
  static String adminApproveUser(int id) =>
      '$baseUrl/admin-mobile/approvals/$id/approve';
  static String adminRejectUser(int id) =>
      '$baseUrl/admin-mobile/approvals/$id/reject';
  ...
  static String saMarkPaid(int userId) =>
      '$saBase/admin/analytics/mark-paid/$userId';
  static String saReceivePayment(int userId) =>
      '$saBase/admin/analytics/receieve/$userId';
  // Settings
  ...
  static String othersRequestClose(int id) =>
      '$baseUrl/others/proformas/$id/request-close';
  static const String othersReceivedProformas =
      '$baseUrl/others/received-proformas';

  // Business Owner role
  static const String businessOwnerDashboard =
      '$baseUrl/business-owner/dashboard';
  static const String businessOwnerProformas =
      '$baseUrl/business-owner/proformas';
  static String businessOwnerProformaDetail(int id) =>
      '$baseUrl/business-owner/proformas/$id';
  static String businessOwnerRequestClose(int id) =>
      '$baseUrl/business-owner/proformas/$id/request-close';
  static const String businessOwnerReceivedProformas =
      '$baseUrl/business-owner/received-proformas';
  static const String businessOwnerBalance = '$baseUrl/business-owner/balance';
  static const String businessOwnerWithdraw =
      '$baseUrl/business-owner/withdraw';
  static const String businessOwnerEmployees =
      '$baseUrl/business-owner/employees';
  static String businessOwnerDeleteEmployee(int id) =>
      '$baseUrl/business-owner/employees/$id';
  static const String businessOwnerBilling = '$baseUrl/business-owner/billing';
  static const String businessOwnerBillingPlan =
      '$baseUrl/business-owner/billing/plan';
  static const String businessOwnerBillingStatements =
      '$baseUrl/business-owner/billing/statements';
  static String businessOwnerStatementDetail(String sku) =>
      '$baseUrl/business-owner/billing/statements/$sku';
  static const String businessOwnerBillingInvoices =
      '$baseUrl/business-owner/billing/invoices';
  ...
  static String garageApplyProforma(int id) =>
      '$baseUrl/garage/proformas/$id/apply';
  ...
  static const String garageReceivedProformas =
      '$baseUrl/garage/received-proformas';
  ...
  static String garageRequestClose(int id) =>
      '$baseUrl/garage/proformas/$id/request-close';
  ...
  static const String garageBillingStatements =
      '$baseUrl/garage/billing/statements';
  static String garageBillingStatementDetail(String sku) =>
      '$baseUrl/garage/billing/statements/$sku';
  static const String garageBillingInvoices =
      '$baseUrl/garage/billing/invoices';
  ...
  static String shopApplyProforma(int id) =>
      '$baseUrl/shop/proformas/$id/apply';
  ...
  static String insuranceProformaDetail(int id) =>
      '$baseUrl/insurance/proformas/$id';
  static String insuranceCreateFile = '$baseUrl/insurance/create-file';
  static String insuranceRequestClose(int id) =>
      '$baseUrl/insurance/proformas/$id/request-close';
  static const String insuranceReceivedProformas =
      '$baseUrl/insurance/received-proformas';
  ...
  static String insuranceDeletePartner(int id) =>
      '$baseUrl/insurance/partners/$id';
  static const String insuranceEmployees = '$baseUrl/insurance/employees';
  static String insuranceDeleteEmployee(int id) =>
      '$baseUrl/insurance/employees/$id';
  static const String insuranceAvailablePartners =
      '$baseUrl/insurance/partners/available';
  ...
  static const String insuranceBillingStatements =
      '$baseUrl/insurance/billing/statements';
  static String insuranceStatementDetail(String sku) =>
      '$baseUrl/insurance/billing/statements/$sku';
  ...
  static const String _createProformaBusinessOwner =
      '$baseUrl/business-owner/create-file';
  static const String _createProformaGarage = '$baseUrl/garage/create-file';
  static const String _createProformaInsurance =
      '$baseUrl/insurance/create-file';
