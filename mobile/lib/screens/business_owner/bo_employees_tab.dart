...
class BOEmployeesTab extends StatefulWidget {
  const BOEmployeesTab({super.key});

  @override
  State<BOEmployeesTab> createState() => _BOEmployeesTabState();
}

class _BOEmployeesTabState extends State<BOEmployeesTab> {
  bool _loading = true;
  ...
  Future<void> _load() async {
    ...
    final result = await BusinessOwnerService.listEmployees();
    if (!mounted) return;
  ...
  Future<void> _confirmDelete(User employee) async {
    ...
    final res = await BusinessOwnerService.deleteEmployee(employee.id);
    if (!mounted) return;
...
class _AddEmployeeSheetState extends State<_AddEmployeeSheet> {
  ...
  Future<void> _submit() async {
    ...
    final res = await BusinessOwnerService.createEmployee(
